# -*- coding: utf-8 -*-
"""
Created on Fri Jul 13 09:49:24 2018
...
class Image_Segmentation(object):
    ...
    def img_group(self, thresh_region, kernel_dilate,scalex,scaley):              
    ...
    def Get_Region(self, plot_flag = None, Binary_Threshold=threshold, scalex=None , scaley=None):
...
#******************************************************************************
        ...
        Small_box, Small_region, plot_img_small = self.img_group(thresh_copy,kernel_dilate,scalex,scaley)
                    
        kernel_dilate = np.uint8(np.ones((4,4)))      
        kernel_dilate[2,:]=0
        
        Big_box, Big_region, plot_img_big = self.img_group(Small_region,kernel_dilate,scalex,scaley)                   
...
for i in range(len(lable)) :
    ...
    for j in range(100):
        ...
        big_regions,small_regions, img_processed = img_process.Get_Region(plot_flag=False,Binary_Threshold=threshold,scalex=x,scaley=y)
